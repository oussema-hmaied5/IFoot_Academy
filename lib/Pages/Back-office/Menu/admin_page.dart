...
class _AdminMainPageState extends State<AdminMainPage> {
  ...
  Widget build(BuildContext context) {
    return TemplatePageBack(
      title: currentView == 'player' ? 'Gestion des Joueurs' : 'Gestion des Coachs',
      actions: [
        IconButton(
          ...
          tooltip: currentView == 'player' ? 'Basculer vers Coach' : 'Basculer vers Joueur',
        ),
      ],
      body: currentView == 'player' ? _buildPlayerContent() : _buildCoachContent(),
      footerIndex: 0,
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSectionCard(
            ...
            description: 'Organisez les joueurs par groupes et gérez leurs affectations.',
            icon: Icons.group,
          ...
          _buildSectionCard(
            ...
            description: 'Planifiez et consultez les entraînements pour les joueurs.',
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSectionCard(
            ...
            description: 'Analysez les performances et les contributions des coachs.',
