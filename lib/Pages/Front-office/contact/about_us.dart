...
import 'package:ifoot_academy/main.dart';
...
class AboutUsPage extends StatelessWidget {
  ...
  void _navigateToSection(BuildContext context, SectionData section) {
    if (section.title == 'Contact Information') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const ContactPage()), // Use the ContactPage from contact.dart
      );
...
class InnerPage extends StatelessWidget {
  ...
  const InnerPage(this.section, {super.key});
